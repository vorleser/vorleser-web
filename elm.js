...
var _user$project$Config$baseUrl = 'http://localhost:8000/api/';

var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {login_view: a, login_token: b, current_view: c, mdl: d};
	});
var _user$project$Model$LoginViewModel = F2(
	function (a, b) {
		return {name: a, password: b};
	});
var _user$project$Model$LibraryView = {ctor: 'LibraryView'};
var _user$project$Model$LoginView = {ctor: 'LoginView'};

var _user$project$Auth$authenticatedApiCall = F5(
	function (method, model, url, decoder, msg) {
		var _p0 = model.login_token;
		if (_p0.ctor === 'Just') {
			var request = _elm_lang$http$Http$request(
				{
					...
					url: A2(_elm_lang$core$Basics_ops['++'], _user$project$Config$baseUrl, url),
					expect: _elm_lang$http$Http$expectJson(decoder),
					body: _elm_lang$http$Http$emptyBody,
					timeout: _elm_lang$core$Maybe$Nothing,
					withCredentials: false
...
var _user$project$Auth$authenticatedGet = F4(
	function (model, url, decoder, msg) {
		return A5(_user$project$Auth$authenticatedApiCall, 'GET', model, url, decoder, msg);
	});
...
var _user$project$Main$login = F2(
		...
		switch (_p0.ctor) {
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$login, model.name, model.password)
				};
		}
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'Login':
				var _p2 = A2(_user$project$Main$loginViewUpdate, _p1._0, model.login_view);
				var data = _p2._0;
				var cmd = _p2._1;
				return {
					ctor: '_Tuple2',
				...
				if (_p3.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								login_token: _elm_lang$core$Maybe$Just(_p3._0.secret)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$Main$init = {
	...
	_0: A4(
		...
		A2(_user$project$Model$LoginViewModel, '', ''),
		_elm_lang$core$Maybe$Nothing,
		_user$project$Model$LoginView,
