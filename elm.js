...
var _user$project$Main$view = function (model) {
	return A4(
		...
		},
		{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _debois$elm_mdl$Material_Layout$href('https://github.com/hatzel/vorleser-web'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
			...
			drawer: {
				ctor: '::',
				_0: _elm_lang$html$Html$text('LOL'),
				_1: {ctor: '[]'}
			},
			tabs: {
				ctor: '_Tuple2',
...
var _user$project$Main$loginViewUpdate = F2(
	function (msg, model) {
		...
		switch (_p6.ctor) {
			...
			default:
				var _p7 = A2(_user$project$Main$updateServerUrl, model, login_model.serverUrl);
				var new_model = _p7._0;
				var msg = _p7._1;
				return {
					ctor: '_Tuple2',
					_0: new_model,
	...
	function (msg, model) {
		...
		switch (_p8.ctor) {
			case 'PlayBook':
				...
				var progress = A2(
					...
					A2(
						...
						A2(_elm_lang$core$Dict$get, _p11, model.playstates)));
				var modelPlayback = model.playback;
				var _p9 = model.loginToken;
				if (_p9.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								playback: _elm_lang$core$Native_Utils.update(
									modelPlayback,
									{
										currentBook: _elm_lang$core$Maybe$Just(_p11),
										hasPlayed: false,
										progress: progress,
										playbackBehaviour: _p8._1
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
											...
											A2(
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_p11,
														A2(_elm_lang$core$Basics_ops['++'], '?auth=', _p9._0)))),
											progress,
											model.playback.volume))),
								_1: {
									ctor: '::',
									_0: _user$project$Session$saveLastPlayed(_p11),
									_1: {ctor: '[]'}
								}
							})
					};
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							...
							end: {line: 160, column: 91}
						},
						_p9)('Logged in yet no login token. This is a bug, please report it.');
				}
			case 'BookReadyAt':
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_0: _user$project$Audio$command(
								_user$project$Audio$toJs(
									_user$project$Audio$SkipTo(_p12))),
							_1: {
								ctor: '::',
			...
			case 'UpdateLocalPlaystate':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Playstates$updateLocalPlaystate, model, _p8._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'SetVolume':
				...
				return {
					...
					_1: _user$project$Audio$command(
						_user$project$Audio$toJs(
							_user$project$Audio$SetVolume(_p13)))
				};
			default:
				var modelPlayback = model.playback;
				return {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p14.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Msg$Mdl, _p14._0, model);
			case 'Snackbar':
				return A2(
					_debois$elm_mdl$Material_Helpers$map2nd,
					_elm_lang$core$Platform_Cmd$map(_user$project$Msg$Snackbar),
					A2(
						...
						A2(_debois$elm_mdl$Material_Snackbar$update, _p14._0, model.snackbar)));
			case 'Login':
				return A2(_user$project$Main$loginViewUpdate, _p14._0, model);
			case 'LoggedIn':
				var _p15 = _p14._0;
				if (_p15.ctor === 'Ok') {
					var _p16 = _p15._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								loginToken: _elm_lang$core$Maybe$Just(_p16.secret),
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								...
								_1: {
									ctor: '::',
									_0: _user$project$Session$saveSession(_p16.secret),
									_1: {ctor: '[]'}
								}
							})
					};
				} else {
					return A2(_user$project$Main$handleLoginError, _p15._0, model);
				}
				...
				if (_p17.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								books: _user$project$Main$bookDict(_p18.books),
								playstates: _user$project$Main$playstateDict(_p18.playstates),
								chapters: _user$project$Main$chapterDict(_p18.chapters)
							}),
						_1: _user$project$Session$requestLastPlayed(
							{ctor: '_Tuple0'})
					};
				} else {
					return A3(_user$project$Error$handleHttpError, _p17._0, 'fetching data', model);
				}
			case 'ReceiveBooks':
				var _p19 = _p14._0;
				if (_p19.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								books: _user$project$Main$bookDict(_p19._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return A3(_user$project$Error$handleHttpError, _p19._0, 'fetching books', model);
				}
			case 'UpdatedPlaystates':
				return A2(
					...
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'Playback':
				return A2(_user$project$Main$playbackUpdate, _p14._0, model);
			...
			case 'UpdateServerUrl':
				return A2(_user$project$Main$updateServerUrl, model, _p14._0);
			case 'Startup':
				var _p20 = _p14._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							serverUrl: _p20.serverUrl,
							loginToken: _elm_lang$core$Maybe$Just(_p20.loginToken),
							currentView: _user$project$Model$MainView
						}),
			...
			default:
				var _p23 = model.playback.currentBook;
				if (_p23.ctor === 'Nothing') {
					return A2(
						_user$project$Main$playbackUpdate,
						A2(_user$project$Msg$PlayBook, _p14._0, _user$project$PlaybackBehaviour$Manual),
						model);
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
